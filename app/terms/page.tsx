  ...
  return (
    <div className="pt-36 pb-20">
      <div className="container max-w-3xl">
        <h1 className="font-extrabold text-slate-900 text-4xl mb-3 tracking-tight">Terms of Service</h1>
        ...
        <div className="space-y-8 text-slate-600 leading-relaxed">
          {[
            ...
            <div key={title as string}>
              <h2 className="font-bold text-slate-900 text-xl mb-2">{title as string}</h2>
